# Public Key
Represents a ALV public key and is needed to be able to receive ALV, as is usually represented as a ALV [Address](address.md). 

A PublicKey in alveycore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new alveycore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = alveycore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
