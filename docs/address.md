# ALV Address
Represents a ALV address. Addresses are the most popular way to make ALV transactions.

## Instantiate an Address
To be able to receive ALVs an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
